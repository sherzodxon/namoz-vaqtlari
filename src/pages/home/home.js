...
const Home = () => {
        ...
        const getLocation = () => {
            return axios.get(`https://api.bigdatacloud.net/data/reverse-geocode-client?latitude=${(latitude || null)}&longitude=${longitude|| null}`).then(res => res.data);
        }
        const {
            data: locData,
            isLoading: locLoading,
        } = useQuery(['geo'], getLocation);
